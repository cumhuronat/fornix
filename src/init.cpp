...
// ********************************************************* Step 8: load wallet
    ...
    */
    ...
    // This is just for beta testing to ensure a beta network doesn't live on past the 2 week beta testing period
    // as not all functionality is present or in full working order yet (such as content suppression).
    int curHeight_beta = chainActive.Height();
    if (curHeight_beta >= 20160) {
      StartShutdown();
    }
